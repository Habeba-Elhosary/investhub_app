...
class AllBatteriesScreen extends StatelessWidget {
  const AllBatteriesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(LocaleKeys.home_all_batteries.tr())),
      body: BlocProvider<AllBatteriesCubit>(
        create: (context) => sl<AllBatteriesCubit>()
          ..clearFilter()
          ..initScoll(),
        child: BlocBuilder<AllBatteriesCubit, AllBatteriesState>(
                ...
                children: [
                  TextFormField(
                    ...
                    onChanged: (String value) {
                      context.read<AllBatteriesCubit>().setFilter(
                        searchText: value,
                      );
                    },
                    ...
                    decoration: InputDecoration(
                      hintText: LocaleKeys.home_search_batteries.tr(),
